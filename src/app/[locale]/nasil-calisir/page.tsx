      ...
      <main className="pb-[76px] md:pb-0">
        ...
        <section className="bg-bg-surface border-b border-[0.5px] border-border-default py-44 md:py-60">
          <Container className="flex flex-col items-center text-center gap-16">
            ...
            <Link href={routes.quote(locale)} className="inline-flex items-center gap-8 bg-accent text-white px-32 py-16 rounded-btn font-medium text-[14px] hover:opacity-90 transition-opacity mt-8">
              Hemen Başla <ArrowRight size={16} strokeWidth={1.5} aria-hidden />
            </Link>
          </Container>
        </section>
