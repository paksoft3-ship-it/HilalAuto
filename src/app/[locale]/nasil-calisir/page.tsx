    ...
    <>
      ...
      <main className="pb-[76px] md:pb-0">
        ...
        <section className="py-44 md:py-60">
          <Container>
            <SectionHeader title={t("stepsTitle", { default: "6 Adımlı Süreç" })} subtitle={t("stepsSubtitle", { default: "Başvurudan ödemeye kadar her adım." })} align="left" className="mb-32 md:mb-44" />
        ...
        <section className="py-44 md:py-60">
          <Container>
            <SectionHeader title={t("trustTitle", { default: "Güvenli mi?" })} subtitle={t("trustSubtitle", { default: "Sürecimiz tamamen şeffaf ve güvenlidir." })} align="left" className="mb-32 md:mb-44" />
