  ...
  return (
    <>
      ...
      <main className="pb-[76px] md:pb-0">
        {/* Hero */}
        <section className="bg-surface-container-lowest border-b border-[0.5px] border-border-default py-44 md:py-60">
          <Container className="flex flex-col items-center text-center gap-16">
            <Badge variant="accent">Hakkımızda</Badge>
            <h1 className="text-section-title-mobile md:text-[40px] font-medium tracking-heading text-on-surface max-w-[640px]">
              Türkiye Genelinde Hasarlı Araç Alımında Güvenilir Adres
            </h1>
            <p className="text-[14px] text-muted-text max-w-[520px] leading-relaxed">
